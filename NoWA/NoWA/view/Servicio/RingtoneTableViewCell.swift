...
class RingtoneTableViewCell: GenericTableViewCell , pickerDelegate {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String!) {
        ...
        let ring2 = ["ringtoneID": 1, "name": "iphone_6_original.mp3"]
        ringtonesArray.addObject(ring1)
        ringtonesArray.addObject(ring2)
        
        ringtonesPicker.addObject("ringtone.mp3")
        ringtonesPicker.addObject("iphone_6_original.mp3")
